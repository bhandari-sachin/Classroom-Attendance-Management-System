pipeline {
    ...
    post {
        success {
            echo "Pipeline succeeded! Backend: ${DOCKER_USERNAME}/${BACKEND_IMAGE_REPO}:${DOCKER_IMAGE_TAG}"
            echo "Pipeline succeeded! Frontend: ${DOCKER_USERNAME}/${FRONTEND_IMAGE_REPO}:${DOCKER_IMAGE_TAG}"
        }
        failure {
